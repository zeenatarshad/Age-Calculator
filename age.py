...
root.configure(bg="#ffc6c6")   #setting up backround color
root.geometry("400x300")    #fixing the size of the window
new=Label(root,bg="#ffc6c6")  #declaring a lable
...
def age(b_date,b_month,b_year):
    ...
    new=Label(root,text="YOUR AGE \n"+resulty+" YEARS "+resultm+" MONTHS "+ resultd+" DAYS ",fg="#990000",bg="#ffc6c6",borderwidth=6)
...
title_label=Label(root,text="AGE CALCULATOR",borderwidth=10,fg="#cc3300",bg="#ffc6c6")
title_label.config(font=("Broadway",29))
title_label.grid(row=0,column=0,columnspan=3)
label_date=Label(root,text="BIRTH DATE : ",borderwidth=4,fg="#990000",bg="#ffc6c6")
label_date.config(font=("Arial Rounded MT Bold",15))
label_date.grid(row=1,column=0)
label_month=Label(root,text="BIRTH MONTH : ",borderwidth=5,fg="#990000",bg="#ffc6c6")
label_month.config(font=("Arial Rounded MT Bold",15))
label_month.grid(row=2,column=0)
label_year=Label(root,text="BIRTH YEAR : ",borderwidth=9,fg="#990000",bg="#ffc6c6")
...
submit=Button(root,text="GET AGE!!",width=10,anchor=CENTER,command=lambda:age(b_date,b_month,b_year),bg="#cc3300",fg="#ffc6c6",borderwidth=5)
submit.grid(row=4,column=0)

#calling clean function in button widget
clear=Button(root,text="CLEAR",width=10,command=lambda:clean(entry_date,entry_month,entry_year),bg="#cc3300",fg="#ffc6c6",borderwidth=5)
